...
public class QuickActionService {
    ...
    public QuickActionService(QuickActionRepository repository) {
    ...
    public List<QuickActionDto> listVisible() {
        return repository.findAllSorted().stream().filter(QuickActionEntity::isVisible).map(this::toDto).toList();
    }
    ...
    private QuickActionDto toDto(QuickActionEntity entity) {
    ...
    private QuickActionEntity toEntity(QuickActionDto dto) {
